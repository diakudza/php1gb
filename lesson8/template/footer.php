...
<footer class="footer  container">
    <? require(ROOT."/template/advantages.php");?>
        <section class="footer__white  container">
            <h2 class="visually-hidden">subscripe</h2>
            <div class="footer__white-comment">
                <img class="footer__white-img" height="96" src="../public/img/Intersect.png" alt="foot_foto">
        ...
        <section class="footer__copyright width container">
            ...
            <ul class="footer__copyright-soc ">
                <li class="footer__copyright-img">
                    <a hreh="#"><img class="footer-img-soc-im" height="16" src="../public/img/soc_1.png" alt="Facebook"></a>
                </li>
                <li class="footer__copyright-img">
                    <img class="footer-img-soc-im" height="16" src="../public/img/soc_2.png" alt="Instagram">
                </li>
                <li class="footer__copyright-img">
                    <img class="footer-img-soc-im" height="16" src="../public/img/soc_3.png" alt="Pinterest">
                </li>
                <li class="footer__copyright-img">
                    <img class="footer-img-soc-im" height="16" src="../public/img/spc_4.png" alt="Twitter">
                </li>
            </ul>
        </section>
</footer>