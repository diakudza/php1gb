...
if(!empty($_POST)){
    ...
    if(mysqli_num_rows(execQuery("SELECT login FROM user WHERE login='$login'")) == 1){
...
$user=mysqli_fetch_assoc(execQuery("SELECT * FROM user WHERE idUser={$_SESSION['user_id']}"));
var_dump($user);
?>
