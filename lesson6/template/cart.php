...
<main class="white__back container">
        ...
        <?php
                foreach ( execQuery('SELECT id_good,id FROM cart ') as $item){
                    cardInCart($item['id_good'],$item['id']);
            }
        ?>
        ...
        <form class="form">
            ...
            <div class="form__checkout">
                <h3>sub total <span>$<?= cartSum() ?></span></h3>
                <h4>grand total <span>$<?= cartSum() ?></span></h4>
